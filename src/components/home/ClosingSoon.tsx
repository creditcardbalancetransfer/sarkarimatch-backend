...
/** Skeleton for a single closing-soon card */
const SkeletonClosingCard: FC = () => (
  <div class="snap-start flex-shrink-0 w-[300px] sm:w-[320px]">
    <div class="skeleton-card bg-white dark:bg-surface-card-dark rounded-xl border border-gray-100 dark:border-gray-800 overflow-hidden">
      <div class="p-5">
        {/* Urgency bar */}
        <div class="skeleton-bar mb-4" style="width: 120px; height: 14px;" />
        {/* Title */}
        <div class="skeleton-bar mb-1" style="width: 100%; height: 16px;" />
        <div class="skeleton-bar mb-1" style="width: 80%; height: 16px;" />
        {/* Org */}
        <div class="skeleton-bar mb-2" style="width: 60%; height: 12px;" />
        {/* Badge + count */}
        <div class="flex gap-2 mb-4">
          <div class="skeleton-bar" style="width: 70px; height: 20px; border-radius: 9999px;" />
          <div class="skeleton-bar" style="width: 80px; height: 20px;" />
        </div>
        {/* Countdown */}
        <div class="skeleton-bar mb-4" style="width: 100%; height: 40px; border-radius: 8px;" />
        {/* Button */}
    ...
    <section class="py-16 md:py-24 bg-surface-light dark:bg-surface-dark reveal-section" id="closing-soon">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="skeleton-container" aria-hidden="true">
          <div class="closing-carousel flex gap-4 overflow-x-auto pb-4 px-1">
            <SkeletonClosingCard />
            <SkeletonClosingCard />
            <SkeletonClosingCard />
          </div>
              ...
              {closingJobs.map((job, index) => {
                ...
                return (
                  <div
                    key={job.id}
                    role="listitem"
                    class={`closing-card snap-start flex-shrink-0 w-[300px] sm:w-[320px] reveal-child reveal-stagger-${index + 1}`}
                  >
                    <div
                    ...
                    >
                      ...
                      <div class={`absolute top-0 left-0 right-0 h-1 ${dotColor}`} />
                      ...
                      <div class="p-5">
                        ...
                        {/* Live countdown timer — explicit height to prevent CLS */}
                        <div
