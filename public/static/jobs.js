...
(function () {
  ...
  function openTooltip(jobId, triggerEl) {
    ...
    html += '<div class="p-2.5 border-t border-gray-100 dark:border-gray-700 text-center">' +
      '<a href="/jobs/' + jobId + '" class="text-xs font-semibold text-brand-primary dark:text-blue-400 hover:underline">View Full Details <svg class="w-3.5 h-3.5 inline ml-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"/></svg></a>' +
    '</div>';
